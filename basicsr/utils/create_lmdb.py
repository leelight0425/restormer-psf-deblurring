...
def create_lmdb_for_div2k_psf():
    """Create LMDB files for DIV2K training and validation sets for PSF deblurring.

    Only GT (clean) images are stored; degradation is applied on-the-fly.
    LMDB output paths follow the NAFNet dataset layout.
    """
    # ---- Training set ----
    folder_path = 'E:/code/NAFNet/datasets/DIV2K/DIV2K_train_HR'
    lmdb_path = 'E:/code/NAFNet/datasets/DIV2K/DIV2K_train_HR.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # ---- Validation set ----
    folder_path = 'E:/code/NAFNet/datasets/DIV2K/DIV2K_valid_HR'
    lmdb_path = 'E:/code/NAFNet/datasets/DIV2K/DIV2K_valid_HR.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    print('DIV2K PSF LMDB creation done: training + validation sets.')
